...
import com.project.cloneproject.security.filter.FormLoginFilter;
import com.project.cloneproject.security.filter.JwtAuthFilter;
import com.project.cloneproject.security.jwt.HeaderTokenExtractor;
import com.project.cloneproject.security.provider.FormLoginAuthProvider;
import com.project.cloneproject.security.provider.JWTAuthProvider;
...
//        skipPathList.add("GET,/oauth/google/callback");
        ...
        skipPathList.add("POST,/member/signup");  //회원가입 사진 있을때
        skipPathList.add("POST,/api/member/signup");  //회원가입 사진없이
