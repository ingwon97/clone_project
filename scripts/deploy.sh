...
nohup java -jar /home/ubuntu/app/foocebak/deploy/clone-project-0.0.1-SNAPSHOT.jar --spring.config.location=./application.properties --server.port=8000 -Duser.timezone="Asia/Seoul"&
