...
DEPLOY_PATH=/home/app/$PROJECT_NAME/
...
nohup java -jar clone-project-0.0.1-SNAPSHOT.jar --spring.config.location=./application.properties >> $APPLICATION_LOG_PATH 2> $DEPLOY_ERR_LOG_PATH &
